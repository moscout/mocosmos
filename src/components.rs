...
bitflags! {
	...
	pub struct Action: u64 {
		...
		const ZoomIn =			0b0000000000000000000000000000000000000000001000000000000000000000;
		const ZoomOut =			0b0000000000000000000000000000000000000000010000000000000000000000;
		const FullscreenOn =	0b0000000000000000000000000000000000000000100000000000000000000000;
		const FullscreenOff =	0b0000000000000000000000000000000000000001000000000000000000000000;
	}
}
...
pub struct GameStates {
	...
	pub zoom: f32,
	pub scaled: Instant,
	// Current player's center position.
